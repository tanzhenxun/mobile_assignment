...
import com.example.project.ProposalAdapter
    ...
    override fun onCreateView(
        ...
        db.collection("users").document(userId).get().addOnSuccessListener { userSnapshot ->
            if (userSnapshot.exists()) {
                ...
                val submissionReference = submissionReference2.whereEqualTo("label", "Poster Report")
...
//                                    dataList.add(parentData)
                ...
                val submissionReference3 = submissionReference2.whereEqualTo("label", "Poster PPT")
                    .whereEqualTo("batch", studentBatch)
